...
public class TodoDao {
	...
	public Integer insert(String todo) {
		SqlParameterSource params = new BeanPropertySqlParameterSource(new Todo().setTodo(todo));
	...
	public int update(Todo todo) {
		...
		return jdbc.update(TodoSqls.UPDATE_STATE, params);
	}
